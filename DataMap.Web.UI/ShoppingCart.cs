...
namespace DataMap.Web.UI
{
    ...
    public partial class ShopCart
    {
        ...
        public static bool Add(int article_id, int goods_id, int quantity)
        {
            ...
            if (ls != null)
            {
                Model.cart_keys modelt = ls.Find(p => p.article_id == article_id);
                if (modelt != null)
                {
                    int i = ls.FindIndex(p => p.article_id == article_id);
            ...
            //不存在的则新增
            ls.Add(new Model.cart_keys() { article_id = article_id, quantity = quantity });
        ...
        /// 更新购物车数量
        /// </summary>
        public static Model.cart_keys Update(int article_id, int quantity)
        {
            //如果数量小于1则移除该项
            if (quantity < 1)
            {
        ...
        public static void Clear(int article_id, int goods_id)
        {
            if (article_id > 0)
            {
                ...
                Model.cart_keys modelt = cartList.Find(p => p.article_id == article_id);
                if (modelt != null)
                {
        ...
        public static void Clear(List<Model.cart_keys> ls)
        {
            if (ls != null)
            {
                ...
                {
                    Model.cart_keys model = cartList.Find(p => p.article_id == modelt.article_id);
                    if (model!=null)
                    {
