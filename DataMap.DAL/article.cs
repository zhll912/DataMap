...
namespace DataMap.DAL
{
	...
	public partial class article
	{
            ...
            using (OleDbConnection conn = new OleDbConnection(DbHelperOleDb.connectionString))
            {
                ...
                using (OleDbTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        OleDbParameter[] parameters2 = new OleDbParameter[model.fields.Count + 1];
                        int i = 1;
                        strFieldName.Append("article_id");
                        strFieldVar.Append("@article_id");
                        parameters2[0] = new OleDbParameter("@article_id", OleDbType.Integer, 4);
                        ...
                        foreach (KeyValuePair<string, string> kvp in model.fields)
                        {
                            ...
                            {
                                parameters2[i] = new OleDbParameter("@" + kvp.Key, OleDbType.VarChar, kvp.Value.Length);
                            }
                            else
                            {
                                parameters2[i] = new OleDbParameter("@" + kvp.Key, SqlDbType.NText);
                            }
                        ...
                        DbHelperOleDb.ExecuteSql(conn, trans, strSql2.ToString(), parameters2); //带事务
                        #endregion
                        ...
                        if (model.albums != null)
                        {
                            ...
                            foreach (Model.article_albums modelt in model.albums)
                            {
                                ...
                                OleDbParameter[] parameters3 = {
					                ...
					                new OleDbParameter("@thumb_path", OleDbType.VarChar,255),
					                new OleDbParameter("@original_path", OleDbType.VarChar,255),
                                ...
                                DbHelperOleDb.ExecuteSql(conn, trans, strSql3.ToString(), parameters3); //带事务
                            }
                        }
                        #endregion
                        ...
                        if (model.attach != null)
                        {
                            ...
                            foreach (Model.article_attach modelt in model.attach)
                            {
                                ...
                                DbHelperOleDb.ExecuteSql(conn, trans, strSql4.ToString(), parameters4); //带事务
                            }
                        }
                        #endregion
                        ...
                        if (model.group_price != null)
                        {
                            ...
                            foreach (Model.user_group_price modelt in model.group_price)
                            {
                                ...
                                DbHelperOleDb.ExecuteSql(conn, trans, strSql5.ToString(), parameters5); //带事务
                            }
                        }
                        #endregion
                ...
                using (OleDbTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        if (model.fields.Count > 0)
                        {
                            ...
                            parameters2[i] = new OleDbParameter("@article_id", OleDbType.Integer, 4);
        ...
        public string GetContent(int id)
        {
            ...
            strSql.Append(" where id=" + id);
            string content = Convert.ToString(DbHelperOleDb.GetSingle(strSql.ToString()));
        ...
        public DataSet GetList(string channel_name, int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" where datediff('d',add_time,date())>=0");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" and " + strWhere);
            }
