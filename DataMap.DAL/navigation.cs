...
namespace DataMap.DAL
{
	...
	public partial class navigation
	{
        ...
        {
            string strSql = "select top 1 id from " + databaseprefix + "navigation order by id desc";
        ...
        /// 修改一条记录，带事务
        /// </summary>
        public bool Update(OleDbConnection conn, OleDbTransaction trans, string old_name, string new_name)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 修改一条记录，带事务
        /// </summary>
        public bool Update(OleDbConnection conn, OleDbTransaction trans, string old_name, string new_name, string title, int sort_id)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update " + databaseprefix + "navigation set");
        ...
        /// 修改一条记录，带事务
        /// </summary>
        public bool Update(OleDbConnection conn, OleDbTransaction trans, string old_name, int parent_id, string nav_name, string title, int sort_id)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update " + databaseprefix + "navigation set");
            strSql.Append(" parent_id=@parent_id,");
        ...
        /// 快捷添加系统默认导航，带事务
        /// </summary>
        public int Add(OleDbConnection conn, OleDbTransaction trans, string parent_name, string nav_name, string title, string link_url, int sort_id, int channel_id, string action_type)
        {
            //先根据名称查询该父ID
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id from " + databaseprefix + "navigation");
        ...
        /// 快捷添加系统默认导航，带事务
        /// </summary>
        public int Add(OleDbConnection conn, OleDbTransaction trans, int parent_id, string nav_name, string title, string link_url, int sort_id, int channel_id, string action_type)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into " + databaseprefix + "navigation(");
            strSql.Append("parent_id,channel_id,nav_type,[name],title,link_url,sort_id,action_type,is_lock,is_sys)");
        ...
        /// 得到一个对象实体，带事务
        /// </summary>
        public Model.navigation GetModel(OleDbConnection conn, OleDbTransaction trans, string nav_name)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id,parent_id,channel_id,nav_type,[name],title,sub_title,icon_url,link_url,sort_id,is_lock,remark,action_type,is_sys");
            strSql.Append(" from " + databaseprefix + "navigation ");
