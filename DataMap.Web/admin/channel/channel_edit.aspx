<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="channel_edit.aspx.cs" Inherits="DataMap.Web.admin.channel.channel_edit" ValidateRequest="false" %>
...
<div class="tab-content">
  ...
  <dl>
    ...
    <dd>
      ...
      <span class="Validform_checktip">*开启会员组价格需选中市场价、销售价、库存三个扩展字段</span>
    </dd>
  </dl>
  <dl>
    <dt>排序数字</dt>
