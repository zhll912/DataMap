<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="DataMap.Web.admin.index" %>
    ...
    <div class="nav-right">
      <div class="info">
        ...
        <span>
          ...
          <%=new DataMap.BLL.manager_role().GetTitle(admin_info.role_id) %>
        </span>
      </div>
      <div class="option">
        <i></i>
