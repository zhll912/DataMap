...
namespace DataMap.DBUtility
{
    ...
    public abstract class DbHelperOleDb
    {
        ...
        /// </summary>
        /// <param name="connection">OleDbConnection对象</param>
        /// <param name="trans">OleDbTransaction事务</param>
        /// <param name="SQLString">计算查询结果语句</param>
        /// <returns>查询结果（object）</returns>
        public static object GetSingle(OleDbConnection connection, OleDbTransaction trans, string SQLString, params OleDbParameter[] cmdParms)
        {
